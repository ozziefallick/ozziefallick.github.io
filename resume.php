...
<body>
  <div id="content">
	...
	<span id="resume_subtitle" class="rsubtitle">
				<?php
	...
	<?php for($i=0; $i<count($work_history); $i++) { ?>
		...
		<p><span class="title"><?php echo $work_history[$i][1]; ?></span><br />
		<span class="rsubtitle"><?php echo $work_history[$i][2]; ?></span><br />
		<?php echo $work_history[$i][3]; ?></p>
	      </div>
	      <?php } ?>
	      <div class="item">
		...
		<p><span class="title"><?php echo $lang['phone']; ?></span><br />
		  <span class="rsubtitle"><?php echo($personal['phone_number']); ?></span></p>
		<?php } ?>
		
		<?php if (isset($personal['email_address'])) { ?>
		<p><span class="title"><?php echo $lang['email']; ?></span><br />
		  <span class="rsubtitle"><a href="mailto:<?php echo($personal['email_address']); ?>"><?php echo($personal['email_address']); ?></a></span></p>
		<?php } ?>
		
		<?php if (isset($settings['social_media']) && $settings['social_media'] == true) { ?>
		<?php for($i=0; $i<count($social_media); $i++) { ?>
		      <p><span class="title"><?php echo($social_media[$i][0]); ?></span><br />
			  <span class="rsubtitle"><a href="<?php echo($social_media[$i][1]); ?>"><?php echo(substr($social_media[$i][1], strpos($social_media[$i][1], "://")+3)); ?></a></span></p>
		      <?php } ?>
		      <?php } ?>
	      </div>
      </div>
